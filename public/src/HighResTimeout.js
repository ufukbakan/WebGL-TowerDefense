...
const performanceDotNow = require("performance-now");
const EventEmitter = require("events");

class HighResTimeout extends EventEmitter {
  // prettier-ignore
   ...
   */
  static _stopPolling() {
    requestAnimationFrame.cancel(this._nextFrameId)
