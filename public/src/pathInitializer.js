 ...
 */
 function placeForbiddenPath(scene) {
    ...
    let forbiddenPath1 =  new Mesh(new BoxGeometry(16,mesh_height,1), new MeshBasicMaterial({color: 0xff0000, opacity:0.5, transparent: true}));
    forbiddenPath1.name = "forbidden";
    forbiddenPath1.position.set(0, mesh_height/2, -2);

    let forbiddenPath2 =  new Mesh(new BoxGeometry(1,mesh_height,16), new MeshBasicMaterial({color: 0xff0000, opacity:0.5, transparent: true}));
    forbiddenPath2.name = "forbidden";
    forbiddenPath2.position.set(2, mesh_height/2, 0);

    let forbiddenPath3 =  new Mesh(new BoxGeometry(16,mesh_height,1), new MeshBasicMaterial({color: 0xff0000, opacity:0.5, transparent: true}));
